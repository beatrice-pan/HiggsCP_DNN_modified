...
DATA_URL = 'http://th-www.if.uj.edu.pl/~erichter/forHiggsCP/HiggsCP_data/a1rho/'
...
def download_data_files(args):
    data_path = args.IN
    files = ['a1rho_raw.data.npy', 'a1rho_raw.perm.npy', 'arg_maxs.npy', 'pcovs.npy', 'popts.npy', 'weigths.npy']
    for file in files:
