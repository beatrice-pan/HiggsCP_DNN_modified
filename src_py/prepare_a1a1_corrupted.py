...
def read_raw_all(kinds, args, letters):
    ...
    for i,letter in enumerate(letters):
        name = os.path.join(data_path, "pythia.H.a1a1.1M.%s.CPmix_%s.outTUPLE_labFrame" % (letter, kinds[i]))
        print letter, name
...
if __name__ == "__main__":
    ...
    np.save(os.path.join(data_path, "a1a1_raw.data.npy"), data)
    #np.save(os.path.join(data_path, "a1a1_raw.data2.npy"), data_2)
    #np.save(os.path.join(data_path, "a1a1_raw.data3.npy"), data_3)    
    np.save(os.path.join(data_path, "a1a1_raw.w.npy"), weights.T)
    np.save(os.path.join(data_path, "a1a1_raw.w_00.npy"), weights[:,0])
    np.save(os.path.join(data_path, "a1a1_raw.w_02.npy"), weights[:,1])
    np.save(os.path.join(data_path, "a1a1_raw.w_04.npy"), weights[:,2])
    np.save(os.path.join(data_path, "a1a1_raw.w_06.npy"), weights[:,3])
    np.save(os.path.join(data_path, "a1a1_raw.w_08.npy"), weights[:,4])
    np.save(os.path.join(data_path, "a1a1_raw.w_10.npy"), weights[:,5])
    np.save(os.path.join(data_path, "a1a1_raw.w_12.npy"), weights[:,6])
    np.save(os.path.join(data_path, "a1a1_raw.w_14.npy"), weights[:,7])
    np.save(os.path.join(data_path, "a1a1_raw.w_16.npy"), weights[:,8])
    np.save(os.path.join(data_path, "a1a1_raw.w_18.npy"), weights[:,9])
    np.save(os.path.join(data_path, "a1a1_raw.w_20.npy"), weights[:,10])
