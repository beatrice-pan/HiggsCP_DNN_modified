...
for alpha in [va_alpha1_A, va_alpha1_B, va_alpha1_C, va_alpha2_A, va_alpha2_B, va_alpha2_C]#, va_alpha1_B_new, va_alpha2_B_new]:
	isFilter *= (alpha > 0)
...
va_tau1_nu_long_B_new = va_tau1_nu_long_B_new[isFilter]
...
error_plot(pb_tau1_nu.z, va_tau1_nu_long_B_new, [-1.1, 1.1, 0.0, 200000], 0.02, filename="tau1_nu_long_B_hist_new", title=r"$p_{\nu_1}^z \, (approx. B)$", barrier=1, relflag=True, absflag=False)
