...
for l in layers:
    for	s in sizes:
        ...
        preds = np.load("/net/people/plgerichter/HiggsCP_2019/CPmix-kacper/HiggsCP/temp_results/nn_rhorho_Variant-All_soft_weights_hits_c0s_Unweighted_False_NO_NUM_CLASSES_51_SIZE_{0}_LAYERS_{1}/monit_npy/softmax_preds_w.npy".format(s,l))
