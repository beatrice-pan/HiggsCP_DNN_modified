...
#plt.hist(preds_argmaxs, histtype='step', bins=51, label = r"Classification: $\alpha^{CP}_{max}$ 100")

pathIN  = "../temp_results/nn_rhorho_Variant-All_soft_argmaxs_hits_c0s_Unweighted_False_NO_NUM_CLASSES_51_SIZE_150/monit_npy/"
...
plt.hist(preds_argmaxs, histtype='step', bins=51,  label = r"Classification: $\alpha^{CP}_{max}$ 150")



pathIN  = "../temp_results/nn_rhorho_Variant-All_soft_argmaxs_hits_c0s_Unweighted_False_NO_NUM_CLASSES_51_SIZE_200/monit_npy/"
...
plt.hist(preds_argmaxs, histtype='step', bins=51,  label = r"Classification: $\alpha^{CP}_{max}$ 200")

pathIN  = "../temp_results/nn_rhorho_Variant-All_soft_argmaxs_hits_c0s_Unweighted_False_NO_NUM_CLASSES_51_SIZE_250/monit_npy/"
...
plt.hist(preds_argmaxs, histtype='step', bins=51,  label = r"Classification: $\alpha^{CP}_{max}$ 250")

pathIN  = "../temp_results/nn_rhorho_Variant-All_soft_argmaxs_hits_c0s_Unweighted_False_NO_NUM_CLASSES_51_SIZE_1000/monit_npy/"
...
plt.hist(preds_argmaxs, histtype='step', bins=51, label = r"Classification: $\alpha^{CP}_{max}$ 1000")
