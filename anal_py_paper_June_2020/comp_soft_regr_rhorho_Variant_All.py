...
for i in range(3, 52, 2):
    filelist_rhorho_Variant_All.append('../temp_results/nn_rhorho_Variant-All_soft_weights_hits_c0s_Unweighted_False_NO_NUM_CLASSES_{}/monit_npy/'.format(i))
...
filelist_rhorho_regr_Variant_All.append('../temp_results/nn_rhorho_Variant-All_regr_c012s_hits_c0s_Unweighted_False_NO_NUM_CLASSES_51_SIZE_1000_LAYERS_6/monit_npy/')
